...
function init() {
    ...
    console.log(numbers)
    for (var i = 0; i < 6; i++) {
        $('<div class="quizcard">' + roledict[numbers[i]] + '</div>').data('number', numbers[i])
...
function display_btn() {
    ...
    let btn = "<button id='results' class='progress_button quiz_button progress_button_left'> Next </button>"
