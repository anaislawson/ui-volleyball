...
lessons = {
    ...
    "1": {"lesson_id": "1", "title": "SETTING", "image": "/static/images/learning/setter.png",
    ...
    "2": {"lesson_id": "2", "title": "LIBERO", "image": "/static/images/learning/libero.png",
          "gif": "/static/images/learning/libero.gif", "text": "You are the defender of the team.",
    ...
    "3": {"lesson_id": "3", "title": "OUTSIDE HITTER", "image": "/static/images/learning/layout-2.png",
          "gif": "/static/images/learning/outside-hitter.gif", "text": "You are the “bag of tools”. ",
    ...
    "4": {"lesson_id": "4", "title": "MIDDLE BLOCKING", "image": "/static/images/learning/middleblocker.png",
          "gif": "/static/images/learning/blocker.gif", "text": "You are the team’s tallest athlete! ",
    ...
    "5": {"lesson_id": "5", "title": "OPPOSITE HITTER", "image": "/static/images/learning/oppositehitter.png",
          "gif": "/static/images/learning/opposite.gif",
...
quiz_level_2_empty_dic = {'empty_roles': {
    '1': '', '2': '', '3': '', '4': '', '5': '', '6': ''}, }
...
def quiz_lv3(question_id):
    ...
    active = {1: "Outside Hitter", 2: "Middle Blocker",
              3: "Libero", 4: "Setter", 5: "Opposite Hitter"}

    for x in range(int(question_id) - 1):
        active.pop(int(quiz_level_3.get('questions').get(
            str(x + 1)).get('answer_id')))
